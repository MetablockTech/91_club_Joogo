                    ...
                    ? (o(),
                      de(
                        L,
                        {
                          ...
                          size: "large",
                          color:
                            "linear-gradient(180deg, #7209b7 0%, #d08eff 100%)",
                          onClick: a(f),
                        },
                        {
                          icon: P(() => [

...
function Q(e = {}, i = {}) {
  Object.keys(i).forEach((t) => {
    typeof e[t] > "u"
      ? (e[t] = i[t])
      : se(i[t]) && se(e[t]) && Object.keys(i[t]).length > 0 && Q(e[t], i[t]);
  });
}
const me = {
  body: {},
...
function Ve(...e) {
  const i = V(e.map((t) => t.split(" ")));
  return (
    ge(this, (t) => i.filter((n) => t.classList.contains(n)).length > 0)
      .length > 0
  );
}
function He(e, i) {
    ...
    if (t)
      for (l = 0; l < d.length; l += 1) {
        ...
        u.dom7LiveListeners || (u.dom7LiveListeners = {}),
          ...
          u.dom7LiveListeners[f].push({ listener: n, proxyListener: r }),
      ...
      for (l = 0; l < d.length; l += 1) {
        ...
        u.dom7Listeners || (u.dom7Listeners = {}),
          ...
          u.dom7Listeners[f].push({ listener: n, proxyListener: a }),
  ...
  for (let a = 0; a < r.length; a += 1) {
    ...
    for (let l = 0; l < this.length; l += 1) {
      ...
      if (
        (!t && o.dom7Listeners
          ? (u = o.dom7Listeners[d])
          : t && o.dom7LiveListeners && (u = o.dom7LiveListeners[d]),
        u && u.length)
      )
        for (let f = u.length - 1; f >= 0; f -= 1) {
          ...
          (n &&
            ...
            c.listener.dom7proxy === n)
            ? (o.removeEventListener(d, c.proxyListener, s), u.splice(f, 1))
            : n ||
              (o.removeEventListener(d, c.proxyListener, s), u.splice(f, 1));
        }
    }
  ...
  for (let s = 0; s < t.length; s += 1) {
    ...
    for (let a = 0; a < this.length; a += 1) {
      ...
      if (i.CustomEvent) {
        ...
        (d.dom7EventData = e.filter((o, u) => u > 0)),
          d.dispatchEvent(l),
          (d.dom7EventData = []),
...
function pt(e) {
  if (this.length > 0) {
    const i = this[0];
    return e
      ? i.previousElementSibling && h(i.previousElementSibling).is(e)
...
function mt(e) {
  ...
  for (let t = 0; t < this.length; t += 1)
    this[t].parentNode !== null &&
      (e
        ? h(this[t].parentNode).is(e) && i.push(this[t].parentNode)
...
function Mt({ userAgent: e } = {}) {
  ...
  return (
    !o &&
      ...
      o || (o = [0, 1, "13_0_0"]),
      (p = !1)),
    l && !c && ((r.os = "android"), (r.android = !0)),
    (o || f || u) && ((r.os = "ios"), (r.ios = !0)),
    r
  );
}
function Ot(e = {}) {
        ...
        ((s = new ResizeObserver((u) => {
          r = n.requestAnimationFrame(() => {
            ...
            u.forEach(({ contentBoxSize: S, contentRect: g, target: y }) => {
              (y && y !== e.el) ||
                ((p = g ? g.width : (S[0] || S).inlineSize),
                (m = g ? g.height : (S[0] || S).blockSize));
            }),
              (p !== f || m !== c) && a();
          });
        })),
          ...
          typeof i > "u"
            ...
            : t.eventsListeners[n] &&
              t.eventsListeners[n].forEach((s, r) => {
                (s === i || (s.__emitterProxy && s.__emitterProxy === i)) &&
  ...
  emit(...e) {
    ...
    return (
      typeof e[0] == "string" || Array.isArray(e[0])
        ? ((t = e[0]), (n = e.slice(1, e.length)), (s = i))
        : ((t = e[0].events), (n = e[0].data), (s = e[0].context || i)),
      n.unshift(s),
...
function At() {
  ...
  typeof v == "string" &&
    ...
    n.centeredSlides &&
      n.cssMode &&
      (F(e.wrapperEl, "--swiper-centered-offset-before", ""),
      F(e.wrapperEl, "--swiper-centered-offset-after", ""));
  ...
  for (let b = 0; b < f; b += 1) {
    ...
    if ((O && e.grid.updateSlide(b, E, f, i), E.css("display") !== "none")) {
      if (n.slidesPerView === "auto") {
        ...
        if (
          (N && (E[0].style.transform = "none"),
          W && (E[0].style.webkitTransform = "none"),
          n.roundLengths)
        )
        ...
        N && (E[0].style.transform = N),
          W && (E[0].style.webkitTransform = W),
          n.roundLengths && (x = Math.floor(x));
      } else
        (x = (r - (n.slidesPerView - 1) * v) / n.slidesPerView),
          n.roundLengths && (x = Math.floor(x)),
          u[b] && (u[b].style[i("width")] = `${x}px`);
      u[b] && (u[b].swiperSlideSize = x),
        m.push(x),
        n.centeredSlides
          ? ((C = C + x / 2 + T / 2 + v),
            T === 0 && b !== 0 && (C = C - r / 2 - v),
  ...
  if (
    ...
    n.setWrapperSize &&
      s.css({ [i("width")]: `${e.virtualSize + n.spaceBetween}px` }),
    O && e.grid.updateWrapperSize(x, c, i),
    !n.centeredSlides)
  ) {
    const b = [];
  ...
  if (
    ...
    F(e.wrapperEl, "--swiper-centered-offset-before", `${-c[0]}px`),
      F(
        e.wrapperEl,
    ...
    const b = -e.snapGrid[0],
      E = -e.slidesGrid[0];
    (e.snapGrid = e.snapGrid.map((M) => M + b)),
      (e.slidesGrid = e.slidesGrid.map((M) => M + E));
  }
  if (
    (f !== o && e.emit("slidesLengthChange"),
    c.length !== y &&
...
function Dt(e = (this && this.translate) || 0) {
  ...
  for (let d = 0; d < n.length; d += 1) {
    ...
    ((c >= 0 && c < i.size - 1) ||
      ...
      n.eq(d).addClass(t.slideVisibleClass)),
      (l.progress = s ? -u : u),
...
function Nt(e) {
  ...
  n === 0
    ? ((s = 0), (r = !0), (a = !0))
    : ((s = (e - i.minTranslate()) / n), (r = s <= 0), (a = s >= 1)),
    Object.assign(i, { progress: s, isBeginning: r, isEnd: a }),
  ...
  if (n && s)
    (i.clickedSlide = n),
      i.virtual && i.params.virtual.enabled
        ? (i.clickedIndex = parseInt(h(n).attr("data-swiper-slide-index"), 10))
        : (i.clickedIndex = r);
  else {
  ...
  t.isHorizontal() ? (l = n ? -e : e) : (o = e),
    ...
    s.cssMode
      ? (a[t.isHorizontal() ? "scrollLeft" : "scrollTop"] = t.isHorizontal()
          ...
          : -o)
      : s.virtualTranslate ||
        r.transform(`translate3d(${l}px, ${o}px, ${u}px)`),
    (t.previousTranslate = t.translate),
    (t.translate = t.isHorizontal() ? l : o);
  let f;
  const c = t.maxTranslate() - t.minTranslate();
  c === 0 ? (f = 0) : (f = (e - t.minTranslate()) / c),
    f !== d && t.updateProgress(e),
...
function Xt(e = 0, i = this.params.speed, t = !0, n = !0, s) {
  ...
  if (
    ...
    if (i === 0) d[f ? "scrollLeft" : "scrollTop"] = -u;
      ...
      if (!r.support.smoothScroll)
        return (
          ve({ swiper: r, targetPosition: -u, side: f ? "left" : "top" }), !0
        );
  ...
  return (
    i === 0
      ? (r.setTransition(0),
        r.setTranslate(u),
        t && (r.emit("beforeTransitionStart", i, s), r.emit("transitionEnd")))
      : (r.setTransition(i),
        r.setTranslate(u),
...
function we({ swiper: e, runCallbacks: i, direction: t, step: n }) {
  ...
  let a = t;
  if (
    (a || (s > r ? (a = "next") : s < r ? (a = "prev") : (a = "reset")),
    e.emit(`transition${n}`),
    i && s !== r)
  ) {
    if (a === "reset") {
...
function Qt(e = 0, i = this.params.speed, t = !0, n, s) {
  ...
  if ((r.animating && d.preventInteractionOnTransition) || (!m && !n && !s))
    return !1;
  ...
  if (
    r.initialized &&
    a !== f &&
    ((!r.allowSlideNext && y < r.translate && y < r.minTranslate()) ||
      (!r.allowSlidePrev &&
        y > r.translate &&
        y > r.maxTranslate() &&
        (f || 0) !== a))
  ...
  let w;
  if (
    (a > f ? (w = "next") : a < f ? (w = "prev") : (w = "reset"),
    (c && -y === r.translate) || (!c && y === r.translate))
  )
    return (
  ...
  if (d.cssMode) {
    ...
    if (i === 0) {
      ...
      if (!r.support.smoothScroll)
        return (
          ve({ swiper: r, targetPosition: C, side: v ? "left" : "top" }), !0
        );
...
function ti(e = this.params.speed, i = !0, t) {
  ...
  a.slidesPerView === "auto" &&
    ...
    (d = Math.max(n.slidesPerViewDynamic("current", !0), 1));
  ...
  return a.rewind && n.isEnd
    ? n.slideTo(0, e, i, t)
    : n.slideTo(n.activeIndex + l, e, i, t);
}
...
function ai() {
  ...
  if (t.loopFillGroupWithBlank) {
    ...
    if (l !== t.slidesPerGroup) {
      for (let o = 0; o < l; o += 1) {
        const u = h(i.createElement("div")).addClass(
  ...
  for (let l = 0; l < d.length; l += 1)
    s.append(h(d[l].cloneNode(!0)).addClass(t.slideDuplicateClass));
  for (let l = a.length - 1; l >= 0; l -= 1)
    s.prepend(h(a[l].cloneNode(!0)).addClass(t.slideDuplicateClass));
}
function oi() {
  const e = this;
  ...
  i < n
    ? ((l = t.length - n * 3 + i),
      ...
      e.slideTo(l, 0, !1, !0) &&
        u !== 0 &&
        e.setTranslate((d ? -e.translate : e.translate) - u))
    : i >= t.length - n &&
      ((l = -t.length + i + n),
      (l += n),
      e.slideTo(l, 0, !1, !0) &&
...
function mi(e) {
  ...
  if (
    ...
    let w = !0;
    o.is(s.focusableElements) &&
      ((w = !1), o[0].nodeName === "SELECT" && (s.isTouched = !1)),
      t.activeElement &&
        h(t.activeElement).is(s.focusableElements) &&
        t.activeElement !== o[0] &&
...
function gi(e) {
  ...
  if (!t.allowTouchMove) {
    h(l.target).is(n.focusableElements) || (t.allowClick = !1),
      n.isTouched &&
  ...
  if (
    ...
    h(l.target).is(n.focusableElements)
  ) {
  ...
  if (t.params.threshold && Math.sqrt(c ** 2 + p ** 2) < t.params.threshold)
    return;
  if (typeof n.isScrolling > "u") {
    ...
    (t.isVertical() && r.currentX === r.startX)
      ? (n.isScrolling = !1)
      : c * c + p * p >= 25 &&
        ((y = (Math.atan2(Math.abs(p), Math.abs(c)) * 180) / Math.PI),
      ...
      ? ((S = !1),
        s.resistance &&
          (n.currentTranslate =
            t.minTranslate() -
            1 +
            (-t.minTranslate() + n.startTranslate + m) ** g))
      : m < 0 &&
        ...
        s.resistance &&
          (n.currentTranslate =
            t.maxTranslate() +
            1 -
            (t.maxTranslate() - n.startTranslate - m) ** g)),
...
function vi(e) {
  ...
  if (
    ...
    t.isMoved && n.grabCursor && i.setGrabCursor(!1),
      (t.isMoved = !1),
      (t.startMoving = !1);
    return;
  }
  ...
  if (i.allowClick) {
    ...
    i.updateClickedSlide((w && w[0]) || l.target),
      i.emit("tap click", l),
      u < 300 &&
  ...
  for (
    ...
    typeof a[w + v] < "u"
      ? f >= a[w] && f < a[w + v] && ((c = w), (p = a[w + v] - a[w]))
      : f >= a[w] && ((c = w), (p = a[a.length - 1] - a[a.length - 2]));
  }
  let m = null,
    S = null;
  n.rewind &&
  ...
  if (u > n.longSwipesMs) {
    ...
    i.swipeDirection === "next" &&
      (g >= n.longSwipesRatio
        ? i.slideTo(n.rewind && i.isEnd ? m : c + y)
        : i.slideTo(c)),
    ...
    (l.target === i.navigation.nextEl || l.target === i.navigation.prevEl)
      ? l.target === i.navigation.nextEl
        ? i.slideTo(c + y)
        : i.slideTo(c)
      : (i.swipeDirection === "next" && i.slideTo(m !== null ? m : c + y),
        i.swipeDirection === "prev" && i.slideTo(S !== null ? S : c));
  }
}
function le() {
  const e = this,
  ...
  if (!l.touch)
    ...
    const c =
      s.start === "touchstart" && l.passiveListener && n.passiveListeners
        ? { passive: !0, capture: !1 }
        : !1;
    r[u](s.start, e.onTouchStart, c),
      r[u](
        s.move,
        e.onTouchMove,
        l.passiveListener ? { passive: !1, capture: o } : o,
      ),
      r[u](s.end, e.onTouchEnd, c),
      s.cancel && r[u](s.cancel, e.onTouchEnd, c);
  }
...
function yi() {
  ...
  (e.onTouchStart = mi.bind(e)),
    (e.onTouchMove = gi.bind(e)),
    (e.onTouchEnd = vi.bind(e)),
    t.cssMode && (e.onScroll = wi.bind(e)),
    (e.onClick = Si.bind(e)),
    n.touch && !ae && (i.addEventListener("touchstart", bi), (ae = !0)),
    be(e, "on");
}
function Ti() {
  be(this, "off");
...
function Ei(e, i = "window", t) {
  ...
  for (let d = 0; d < a.length; d += 1) {
    ...
    i === "window"
      ? s.matchMedia(`(min-width: ${o}px)`).matches && (n = l)
      : o <= t.clientWidth && (n = l);
  }
  return n || "max";
}
...
function $i(e, i, t, n, s, r) {
  ...
  !h(e).parent("picture")[0] && (!e.complete || !s) && i
    ? ((d = new a.Image()),
      (d.onload = l),
      (d.onerror = l),
      n && (d.sizes = n),
...
let j = class A {
  constructor(...i) {
    ...
    (s.__swiper__ = !0),
      (s.support = Se()),
      (s.device = Ot({ userAgent: n.userAgent })),
      (s.browser = Lt()),
      (s.eventsListeners = {}),
  ...
  slidesPerViewDynamic(i = "current", t = !1) {
    ...
    if (s.centeredSlides) {
      ...
      for (let p = o + 1; p < r.length; p += 1)
        r[p] &&
          !c &&
          ((f += r[p].swiperSlideSize), (u += 1), f > l && (c = !0));
  ...
  static use(i) {
    return Array.isArray(i)
      ? (i.forEach((t) => A.installModule(t)), A)
      : (A.installModule(i), A);
  }
};
...
function k(e, i) {
  ...
  Object.keys(i)
    ...
    .forEach((n) => {
      typeof e[n] > "u"
        ? (e[n] = i[n])
        : G(i[n]) && G(e[n]) && Object.keys(i[n]).length > 0
          ? i[n].__swiper__
            ? (e[n] = i[n])
            : k(e[n], i[n])
          : (e[n] = i[n]);
...
function Di(
  { el: e, nextEl: i, prevEl: t, paginationEl: n, scrollbarEl: s, swiper: r },
  a,
) {
  ye(a) &&
    i &&
    ...
    Te(a) &&
      n &&
      ((r.params.pagination.el = n), (r.originalParams.pagination.el = n)),
    xe(a) &&
      s &&
...
const Me = (e, i) => {
  ...
  return (
    (n += i.loopAdditionalSlides),
    n > e.length && i.loopedSlidesLimit && (n = e.length),
    n
  );
};
function Ni(e, i, t) {
  const n = i.map(
    (l, o) => (
      l.props || (l.props = {}),
      (l.props.swiperRef = e),
      (l.props["data-swiper-slide-index"] = o),
      l
    ),
  );
  function s(l, o, u) {
  ...
  for (let l = 0; l < r; l += 1) {
    ...
    d.push(s(n[o], l, "append")),
      a.unshift(s(n[n.length - o - 1], l, "prepend"));
  }
...
function ji({
  ...
  l.forEach((T) => {
    ...
    n.includes("children") && i && p && o.virtual.enabled
    ...
    w &&
      (a && (o.scrollbar.el = a), c.init(), c.updateSize(), c.setTranslate()),
    v &&
...
const Vi = (e) => {
  ...
  Fi = {
    ...
    setup(e, i) {
      ...
      if (
        ((v.onAny = function (O) {
          for (
            var x = arguments.length, D = new Array(x > 1 ? x - 1 : 0), b = 1;
            b < x;
            b++
          )
            D[b - 1] = arguments[b];
      ...
      return () => {
        ...
        return z(s, { ref: u, class: Ce(a.value) }, [
          x["container-start"],
          z(r, { class: "swiper-wrapper" }, [
            x["wrapper-start"],
            L(O),
            x["wrapper-end"],
          ]),
          ye(e) && [
            z("div", { ref: g, class: "swiper-button-prev" }),
            z("div", { ref: S, class: "swiper-button-next" }),
          ],
          xe(e) && z("div", { ref: w, class: "swiper-scrollbar" }),
          Te(e) && z("div", { ref: y, class: "swiper-pagination" }),
          x["container-end"],
        ]);
      };
    },
  ...
  Wi = {
    ...
    setup(e, i) {
      ...
      const l = Ae(() => ({
        isActive:
          a.value.indexOf("swiper-slide-active") >= 0 ||
          a.value.indexOf("swiper-slide-duplicate-active") >= 0,
        isVisible: a.value.indexOf("swiper-slide-visible") >= 0,
        isDuplicate: a.value.indexOf("swiper-slide-duplicate") >= 0,
        isPrev:
          a.value.indexOf("swiper-slide-prev") >= 0 ||
          a.value.indexOf("swiper-slide-duplicate-prev") >= 0,
        isNext:
          a.value.indexOf("swiper-slide-next") >= 0 ||
          a.value.indexOf("swiper-slide-duplicate-next") >= 0,
      }));
      return (
        ce("swiperSlide", l),
        () =>
